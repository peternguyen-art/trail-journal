...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-FSAWFBIQ.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-PIA2OB2B.js").then((mod) => ({
...
//# sourceMappingURL=router-LSE2AYCT.js.map
