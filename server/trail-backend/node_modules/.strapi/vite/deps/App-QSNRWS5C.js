...
// node_modules/@strapi/content-type-builder/dist/admin/components/GenericInputs.mjs
var GenericInput = ({ autoComplete, customInputs, description, disabled, intlLabel, labelAction, error, name, onChange, options: options2 = [], placeholder, required, step, type, value: defaultValue, isNullable, autoFocus, attribute, ...rest }) => {
  const { formatMessage } = useIntl();
...
var FormModal = () => {
  ...
  const handleChange = React3.useCallback(({ target: { name, value, type: type2, ...rest } }) => {
  ...
  return (0, import_jsx_runtime35.jsx)(Modal.Root, {
    open: isOpen,
    onOpenChange: handleClosed,
    children: (0, import_jsx_runtime35.jsxs)(Modal.Content, {
      children: [
        (0, import_jsx_runtime35.jsx)(FormModalHeader, {
          actionType,
          attributeName,
        ...
        isPickingAttribute && (0, import_jsx_runtime35.jsx)(AttributeOptions, {
          attributes: displayedAttributes,
          forTarget,
          kind: schemaKind || "collectionType"
        }),
        !isPickingAttribute && (0, import_jsx_runtime35.jsxs)(FormComponent, {
          onSubmit: handleSubmit,
          children: [
            (0, import_jsx_runtime35.jsx)(Modal.Body, {
              children: (0, import_jsx_runtime35.jsxs)(Tabs.Root, {
                variant: "simple",
                value: activeTab,
                onValueChange: (value) => {
                  setActiveTab(value);
                ...
                children: [
                  (0, import_jsx_runtime35.jsxs)(Flex, {
                    justifyContent: "space-between",
                    children: [
                      (0, import_jsx_runtime35.jsx)(FormModalSubHeader, {
                        actionType,
                        forTarget,
                        kind,
                        step,
                      ...
                      (0, import_jsx_runtime35.jsxs)(Tabs.List, {
                        children: [
                          (0, import_jsx_runtime35.jsx)(Tabs.Trigger, {
                            value: "basic",
                            children: formatMessage({
                  ...
                  (0, import_jsx_runtime35.jsx)(Divider, {
                    marginBottom: 6
                  }),
                  (0, import_jsx_runtime35.jsx)(Tabs.Content, {
                    value: "basic",
                    children: (0, import_jsx_runtime35.jsx)(Flex, {
                      direction: "column",
                      alignItems: "stretch",
                      gap: 6,
                      children: (0, import_jsx_runtime35.jsx)(TabForm, {
                        form: baseForm2,
                        formErrors,
                        genericInputProps,
                        modifiedData,
            ...
            (0, import_jsx_runtime35.jsxs)(Modal.Footer, {
              children: [
                (0, import_jsx_runtime35.jsx)(Button, {
                  type: "button",
                  variant: "tertiary",
                  onClick: (e) => {
                    e.preventDefault();
                ...
                (0, import_jsx_runtime35.jsx)(FormModalEndActions, {
...
var FormModalNavigationProvider = ({ children }) => {
  const [state, setFormModalNavigationState] = (0, import_react11.useState)(INITIAL_STATE_DATA);
  const { trackUsage } = useTracking();
  const onClickSelectCustomField = (0, import_react11.useCallback)(({ attributeType, customFieldUid }) => {
  ...
  const onClickSelectField = (0, import_react11.useCallback)(({ attributeType, step }) => {
  ...
  const onOpenModalAddComponentsToDZ = (0, import_react11.useCallback)(({ dynamicZoneTarget, targetUid }) => {
    setFormModalNavigationState((prevState) => ({
      ...prevState,
      dynamicZoneTarget,
      targetUid,
  ...
  const onOpenModalAddField = (0, import_react11.useCallback)(({ forTarget, targetUid }) => {
    setFormModalNavigationState((prevState) => ({
      ...prevState,
      actionType: "create",
      forTarget,
  ...
  const onOpenModalCreateSchema = (0, import_react11.useCallback)((nextState) => {
    setFormModalNavigationState((prevState) => ({
      ...prevState,
      ...nextState,
      isOpen: true,
  ...
  const onOpenModalEditCustomField = (0, import_react11.useCallback)(({ forTarget, targetUid, attributeName, attributeType, customFieldUid }) => {
    setFormModalNavigationState((prevState) => ({
      ...prevState,
      modalType: "customField",
      customFieldUid,
  ...
  const onOpenModalEditField = (0, import_react11.useCallback)(({ forTarget, targetUid, attributeName, attributeType, step }) => {
    setFormModalNavigationState((prevState) => ({
      ...prevState,
      modalType: "attribute",
      actionType: "edit",
  ...
  const onOpenModalEditSchema = (0, import_react11.useCallback)(({ modalType, forTarget, targetUid, kind }) => {
    setFormModalNavigationState((prevState) => ({
      ...prevState,
      modalType,
      actionType: "edit",
  ...
  const onCloseModal = (0, import_react11.useCallback)(() => {
    setFormModalNavigationState(INITIAL_STATE_DATA);
  }, []);
  const onNavigateToChooseAttributeModal = (0, import_react11.useCallback)(({ forTarget, targetUid }) => {
  ...
  const onNavigateToCreateComponentStep2 = (0, import_react11.useCallback)(() => {
    setFormModalNavigationState((prev) => ({
      ...prev,
  ...
  const onNavigateToAddCompoToDZModal = (0, import_react11.useCallback)(({ dynamicZoneTarget }) => {
    setFormModalNavigationState((prev) => ({
      ...prev,
      dynamicZoneTarget,
      modalType: "addComponentToDynamicZone",
  ...
  const setActiveTab = (0, import_react11.useCallback)((value) => {
    setFormModalNavigationState((prev) => ({
      ...prev,
      activeTab: value
    }));
  ...
  return (0, import_jsx_runtime36.jsx)(FormModalNavigationContext.Provider, {
    value: contextValue,
    children
  });
};
...
var EmptyState = () => {
  ...
  return (0, import_jsx_runtime37.jsx)(import_jsx_runtime37.Fragment, {
    children: (0, import_jsx_runtime37.jsxs)(Flex, {
      justifyContent: "center",
      alignItems: "center",
      height: "100%",
      direction: "column",
...
// node_modules/@strapi/content-type-builder/dist/admin/pages/App/index.mjs
var ListView = (0, import_react12.lazy)(() => import("./ListView-DLRX7QQY.js"));
var App = () => {
  const { formatMessage } = useIntl();
  ...
  const startSectionRef = (0, import_react12.useRef)(startSection);
  (0, import_react12.useEffect)(() => {
    if (startSectionRef.current) {
      startSectionRef.current("contentTypeBuilder");
    }
  }, []);
  return (0, import_jsx_runtime38.jsxs)(Page.Protect, {
    permissions: PERMISSIONS.main,
    children: [
      (0, import_jsx_runtime38.jsx)(Page.Title, {
        children: title
      }),
      (0, import_jsx_runtime38.jsx)(AutoReloadOverlayBlockerProvider, {
        children: (0, import_jsx_runtime38.jsx)(FormModalNavigationProvider, {
          children: (0, import_jsx_runtime38.jsxs)(DataManagerProvider, {
            children: [
              (0, import_jsx_runtime38.jsx)(ExitPrompt, {}),
              (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, {
                children: [
                  autoReload && (0, import_jsx_runtime38.jsx)(FormModal, {}),
                  (0, import_jsx_runtime38.jsx)(Layouts.Root, {
                    sideNav: (0, import_jsx_runtime38.jsx)(ContentTypeBuilderNav, {}),
                    children: (0, import_jsx_runtime38.jsx)(import_react12.Suspense, {
                      fallback: (0, import_jsx_runtime38.jsx)(Page.Loading, {}),
                      children: (0, import_jsx_runtime38.jsxs)(Routes, {
                        children: [
                          (0, import_jsx_runtime38.jsx)(Route, {
                            path: "content-types/create-content-type",
                            element: (0, import_jsx_runtime38.jsx)(EmptyState, {})
                          }),
                          (0, import_jsx_runtime38.jsx)(Route, {
                            path: "content-types/:contentTypeUid",
                            element: (0, import_jsx_runtime38.jsx)(ListView, {})
                          }),
                          (0, import_jsx_runtime38.jsx)(Route, {
...
lodash/lodash.min.js:
   ...
   *)
*/
//# sourceMappingURL=App-QSNRWS5C.js.map
